  ...
  function render() {
    ...
    for(const m of modules) {
      ...
      if(m.type==='chart') {
        ...
        body.innerHTML=`<div class="dom-meta"><span>BINANCE <strong>· USDT</strong></span><span class="cluster-key">Bid × Ask</span><span class="readonly">${m.market==='S'?'Спостереження':'Демо'}</span></div><div class="dom-grid" aria-label="Кластер Bid × Ask, стрічка угод, обсяг заявок, ціна"></div>`;
